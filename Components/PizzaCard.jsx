...
const PizzaCard = ({pizza}) => {
  ...
  return (
    <div className={styles.container} style={ themeState ?style.white:style.black}>
      <Link href={`/products/${pizza._id}`}>
        <div className="linkContain">
          <Image src={pizza.img} width="200" height='200' objectFit='contain'></Image>
          
          <h3 className={styles.title}>{pizza.title}</h3>
          <span className={styles.price} style={ themeState ?style.price:style.black}>${pizza.prices[0]}</span>
